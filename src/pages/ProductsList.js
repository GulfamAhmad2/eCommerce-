        ...
        <div className="products-list-con">
            ...
            <div className="check-filter">
              ...
              <div className="check-filter-check-boxes">
                <div className="check-filter-check-box">
                  ...
                  <label className="checkbox-text" htmlFor="checkbox1">Dell</label>
                </div>

                <div className="check-filter-check-box">
                  <input type="checkbox" id="checkbox2"/>
                  <label className="checkbox-text" htmlFor="checkbox2">Dynabook</label>
                </div>

                <div className="check-filter-check-box">
                  <input type="checkbox" id="checkbox3"/>
                  <label className="checkbox-text" htmlFor="checkbox3">logitech</label>
                </div>

                <div className="check-filter-check-box">
                  <input type="checkbox" id="checkbox4"/>
                  <label className="checkbox-text" htmlFor="checkbox4">rapoo</label>
                </div>

                <div className="check-filter-check-box">
                  <input type="checkbox" id="checkbox5"/>
                  <label className="checkbox-text" htmlFor="checkbox5">reddragon</label>
                </div>

                <div className="check-filter-check-box">
                  <input type="checkbox" id="checkbox6"/>
                  <label className="checkbox-text" htmlFor="checkbox6">rexus</label>
                </div>
              </div>
          ...
          <div className="sort">
            ...
            <div className="product-card">
              ...
              <p className="pr-name">Dynabook T120 Silent Bluetooth Mouse - Black</p>
            ...
            <div className="product-card">
              ...
              <p className="pr-name">Logitech POP Wireless Mouse with Emoji Button Function - Yellow</p>
              <div className="pr-btn">
